        ...
        <div class="col-md-8">
            ...
            <div class="alert alert-info d-flex align-items-center p-5 mb-10">
                ...
                <div class="d-flex flex-column">
                    ...
                    <span>
                         The comments component is a standalone component, that actually depends on a productId or a userId to be present.
                            This is because it will render the collection of comments based on where it is initialized.
                            <br/>
    ...
    <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
        @if($comments->count())
            @if($editComment == false)
                <div wire:key="comment-widget">
                    @include('livewire.comments-widget', ['comments' => $comments])
        ...
        @else
            <div class="row">
                <div class="alert alert-danger d-flex align-items-center p-5 mb-10">
                    ...
                    <!--end::Svg Icon-->
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-primary">There a no comments here...</h4>
                        <span>
                             {{$reasonMessage}}
                            @if($showDocsButton)
                                <hr/>
                                <a href="#" class="btn btn-xs btn-info">View Docs</a>
                            @endif
                         </span>
                    </div>
                </div>
